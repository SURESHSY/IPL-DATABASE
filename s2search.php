...
$sql="SELECT *  FROM teams where tname LIKE '%$t_name%'";
$result=$conn->query($sql);
if($result->num_rows >0)
{
	echo  "<table><tr><th>Team_name</th><th>coach</th><th>captain</th><th>sponsors</th>
	<th>mentor</th><th>owner</th><th>Homeground</th></tr>";
